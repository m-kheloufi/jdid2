...
$('#setexample').on('change', function () {
 ...
 clearGraph();
        clear();
        gettram(file);
        map.setView(new L.LatLng(35.20777265583833, -0.615674942808335), 14);
        ...
        map.setView(new L.LatLng(35.202124120749275, -0.64303643623008), 14);
        ...
        map.setView(new L.LatLng(35.15556500491665, -0.600728988647460), 13);
        ...
        map.setView(new L.LatLng(35.21001968745649, -0.6392197608988681), 14);
        ...
        map.setView(new L.LatLng(35.236716325352084, -0.6007361407682765), 12);
        ...
        map.setView(new L.LatLng(35.20458462765031, -0.6138194597613668), 14);
        ...
        map.setView(new L.LatLng(35.18273786282256, -0.609065067133654), 13);
        ...
        map.setView(new L.LatLng(35.18164817676656, -0.6591367721557618), 14);
        ...
        map.setView(new L.LatLng(35.20118, -0.6343), 13);
